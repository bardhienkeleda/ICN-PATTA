...
class Parsing():
    ...
    def __init__(self, analysisModel, analysisTime):
        ...
        self.mid_path_vector = "/saved_tfidf_vectors/" + "saved_full_vectors/"
    ...
    def ArgParser(self):
        ...
        elif self.analysisModel == "linear_1and2_3004":
        	self.log.info("Attacker is using the Linear SVC model trained with both 1 and 2-grams on 3004-features\n")
        	loaded_model = pickle.load(open(self.basic_directory + self.mid_path_model + "linear_model_1and2gram_3004feat.sav", "rb"))
        	loaded_tfidf = pickle.load(open(self.basic_directory + self.mid_path_vector + "tfidf_vector_1and2gram_3004feat.pk", "rb"))
        ...
        elif self.analysisModel == "multinomial_1and2_3004":
        	self.log.info("Attacker is using the MultinomialNB model trained with both 1 and 2-grams on 3004-features\n")
        	loaded_model = pickle.load(open(self.basic_directory + self.mid_path_model + "multinomial_model_1and2gram_3004feat.sav", "rb"))
        	loaded_tfidf = pickle.load(open(self.basic_directory + self.mid_path_vector + "tfidf_vector_1and2gram_3004feat.pk", "rb"))
        ...
        elif self.analysisModel == "rf_1and2_3004":
            self.log.info("Attacker is using the RandomForestClassifier model trained with both 1 and 2-grams on 3004-features\n")
            loaded_model = pickle.load(open(self.basic_directory + self.mid_path_model + "rf_model_1and2gram_3004feat.sav", "rb"))
            loaded_tfidf = pickle.load(open(self.basic_directory + self.mid_path_vector + "tfidf_vector_1and2gram_3004feat.pk", "rb"))
        ...
        elif self.analysisModel == "svm_1and2_3004":
            self.log.info("Attacker is using the SVC model trained with both 1 and 2-grams on 3004-features\n")
            loaded_model = pickle.load(open(self.basic_directory + self.mid_path_model + "svm_model_1and2gram_3004feat.sav", "rb"))
            loaded_tfidf = pickle.load(open(self.basic_directory + self.mid_path_vector + "tfidf_vector_1and2gram_3004feat.pk", "rb"))
        else:
