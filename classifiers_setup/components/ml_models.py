...
class Models():
    ...
    def random_forests(self):
        ...
        if configuration.WRITE_MODELS:
	    	rf_filename = "rf_model_1gram_866feat.sav"
    ...
    def linear_svc(self):
        ...
        if configuration.PLOT_CM:
            ...
            plt.show()
        if configuration.WRITE_MODELS:
	     	linear_filename = "linear_model_1gram_866feat.sav"
    ...
    def multinomial_nb(self):
        ...
        if configuration.PLOT_CM:
            ...
            plt.show()
        if configuration.WRITE_MODELS:
            multinomial_filename = "multinomial_model_1gram_866feat_dom.sav"
    ...
    def support_vectors(self):
        ...
        if configuration.PLOT_CM:
            ...
            plt.show()
        if configuration.WRITE_MODELS:
            svm_filename = "svm_model_1gram_866feat.sav"
